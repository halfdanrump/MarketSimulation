...
%\captionsetup[subcaption]{skip=10pt}
%\setlength{\abovesubcaptionskip}{15pt plus 10pt plus 10pt}
...
\newcolumntype{W}{>{\arraybackslash}m{10cm}}
%----------------------------------------------------------------------------------------
%	MY OWN COMMANDS
%----------------------------------------------------------------------------------------
...
\newcommand*{\Efilter}[2]{\ensuremath{\mathrm{E}_{\mathcal{F}{#1}}[#2]}}


% % % CLUSTERS
\newcommand*{\C}[1]{\ensuremath{\mathcal{C}_{#1}}}
\newcommand*{\outliers}{\ensuremath{\mathcal{O}}}
...
\newpage
%\rhead{\emph{List of Figures}} % Set the left side page header to "List of Figures"
\listoffigures % Write out the List of Figures

\newpage
%\rhead{\emph{List of Tables}} % Set the left side page header to "List of Tables"
