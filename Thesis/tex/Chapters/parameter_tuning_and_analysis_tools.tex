...
\chapter{Searching model behavior} % Main chapter title
...
[0.49\linewidth]{\includegraphics[width=0.5\textwidth]{}
...
\subsubsection*{Relationship between \timetoreachnewfundamental{} and \roundstable}
\begin{description}
