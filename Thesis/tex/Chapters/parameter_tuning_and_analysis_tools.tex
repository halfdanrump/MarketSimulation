...
[0.49\linewidth]{\includegraphics[width=0.5\textwidth]{d3_issue_21_fitness_scatter_f.png}}
\subcaptionbox{Log-scaled}
[0.49\linewidth]{\includegraphics[width=0.5\textwidth]{d3_issue_21_fitness_scatter_g.png}}
\subcaptionbox{Without outliers}
[0.49\linewidth]{\includegraphics[width=0.5\textwidth]{d3_issue__103_d3_manually_removing_outiers.png}}
\subcaptionbox{Log-scaled and without outliers}
[0.49\linewidth]{\includegraphics[width=0.5\textwidth]{d3_issue__103_d3_manually_removing_outiers_logscaled.png}}
