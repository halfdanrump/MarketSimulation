...
The study found that having agents which are orders of magnitude faster than human traders is not in itself a problem. By simulating the advent of bad news as an instantaneous decrement of the stock price, it was found the fast algorithmic traders did provide the market with some benefits, such as a reduce responsible time to the shock, a smoother descent of the traded to the 

However, it was also found that
making the market more stable, and by increasing the responsiveness of the market after a 
...
\scordervolume{i}, \ssmmordervolume{i} & Volumes of orders submitted by HFT SC and HFT agents, respectively. 
}
