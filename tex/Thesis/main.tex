...
\newcommand{\spa}[2]{$\texttt{#1}_\texttt{#2}$}
...
\listofconstants{ll} % Include a list of Physical Constants (a four column table)
{
$\tau_{i,j}$ & Time delay in rounds from agent $i$ to market $j$. Note that $\tau_{i,j} = \tau_{j,i}$.
}
...
\spa{n}{rounds} & Number of simulation rounds & rounds\\
...
% Symbol & Name & Unit \\
& \spa{n}{mm} & Number of HFT chartist agents &  \\
& \spa{n}{c} & Number of HFT chartist agents &  \\
% Symbol & Name & Unit \\
}
asd
