...
Since the stylized trader model is so predominant in the market simulation literature (see \cite{•}, \cite{•} etc.), we feel that we need to justify our choice of not using it. 
